package com.siwuxie095.forme.algorithm.chapter1st.question6th.answer1st;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String mid = "M";
        String right = "R";
        int steps = SortHanoiTowerByRecursive.hanoiProblem(2, left, mid, right);
