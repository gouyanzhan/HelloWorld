    ...
    private static void selectionSort(int[] arr) {
        ...
        for (int outerIndex = 0; outerIndex < arr.length; outerIndex++) {
            ...
            for (int innerIndex = outerIndex; innerIndex < arr.length; innerIndex++) {
                ...
                System.out.println("outerIndex = " + outerIndex + "，innerIndex = " + innerIndex + "：当前内层循环元素 array[" + innerIndex + "] = " + arr[innerIndex] + "，当前最小元素 array[" + minIndex + "] = " + arr[minIndex]);
            }
            System.out.println("第" + (outerIndex + 1) + "次外层循环结束，第 "+ (outerIndex + 1) +" 小元素是 array[" + minIndex + "] = " + arr[minIndex]);
            System.out.println("交换外层循环元素 array["+outerIndex+"] = "+ arr[outerIndex] + "，和当前最小元素 array[" + minIndex + "] = " + arr[minIndex]);
            System.out.println("交换前：array["+outerIndex+"] = "+ arr[outerIndex] + "，array[" + minIndex + "] = " + arr[minIndex]);
            // 交换两个位置的元素
            swap(arr, outerIndex, minIndex);
            System.out.println("交换后：array["+outerIndex+"] = "+ arr[outerIndex] + "，array[" + minIndex + "] = " + arr[minIndex]);
